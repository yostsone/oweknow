...
export async function createUser(input: Omit<SaveUserInput, 'id'>): Promise<number> {
...
export async function updateUser(userId: number, input: Omit<SaveUserInput, 'id'>): Promise<number> {
